...
const closeBudgetFormButton = document.querySelector("#closeBudgetFormButton");
...
const budgetThemeInput = document.querySelector("#budgetTheme");
const budgetMonthInput = document.querySelector("#budgetMonth");
const budgetFeedback = document.querySelector("#budgetFeedback");
const budgetCards = document.querySelector("#budgetCards");
const budgetEmptyState = document.querySelector(".budget-empty-state");
if (!openBudgetFormButton ||
...
function buildBudgetViewModel(budget, items) {
