...
const openPotFormButton = document.querySelector("#openPotFormButton");
const closePotFormButton = document.querySelector("#closePotFormButton");
const potModal = document.querySelector("#potModal");
const potForm = document.querySelector("#potForm");
const potNameInput = document.querySelector("#potName");
const potTargetInput = document.querySelector("#potTarget");
const potSavedInput = document.querySelector("#potSaved");
const potThemeInput = document.querySelector("#potTheme");
const potFeedback = document.querySelector("#potFeedback");
const potCards = document.querySelector("#potCards");
const potsEmptyState = document.querySelector("#potsEmptyState");
if (!openPotFormButton ||
    !closePotFormButton ||
    !potModal ||
    !potForm ||
    !potNameInput ||
